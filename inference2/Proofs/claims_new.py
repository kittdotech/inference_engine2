...
[ 176,"It is|a contradictory that this wrinkle in that|d carpet is|g not an|r individual|a thing"],
[ 177,"It is|a consistent that this wrinkle in that|d carpet is|g an|r individual|a thing"],
[ 178,"It is|a consistent that a number|i is|a a|r universal"],
[ 179,"It is|a contradictory that a number|i is|a not a|r universal"],
[ 180,"It is|a contradictory that a universal is|a wholly present in space"],
[ 181,"It is|a consistent that no universal is|a wholly present in space"],
[ 182,"It is|a consistent that a set of particles has the quality 'being a man'"],
[ 183,"It is|a consistent that a set of particles does not have the quality 'being a man'"],
[ 184,"It is|a consistent that a particular is|g something that|r instantiates"],
[ 185,"It is|a contradictory that a particular is|g something that|r does not instantiate"],
[ 186,"It is|a consistent that a particular is|r not itself|r instantiated"],
[ 187,"It is|a contradictory that a particular is|r instantiated"],
[ 188,"It is|a consistent that a universal has|m an|r instance"],
[ 189,"It is|a contradictory that a universal does not have|m an|r instance"],
[ 190,"It is|a consistent that this apple is|a real|p and this apple is|a imaginary to Leibniz"],
[ 191,"It is|a contradictory that this apple is|a not real|p and this apple is|a imaginary to Leibniz"],
[ 192,"It is|a contradictory that this apple is|a real|p and this apple is|a fictional to Leibniz"],
[ 193,"It is|a consistent that this apple is|a not real|p and this apple is|a fictional to Leibniz"],
[ 194,"It is|a contradictory that this apple is|a fictional to Aristotle and this apple is|a imaginary to Aristotle"],
[ 195,"It is|a consistent that this apple is|a not fictional to Aristotle and this apple is|a imaginary to Aristotle"]]
    return sent, 455