...
import operator
import sys
from ex_dict import large_dict
from claims import pop_sent
                    ...
                    if len(conjuncts) == 1 and len(list3) >= 1:
                        for k in range(len(conjuncts)):
                            for j in range(len(list3)):
                                ...
                                done = axioms2(greek2, pos1, pos2, rel1, rel2, sub1, obj1, sub2, obj2, osec_sent,
                                               tot_sent, used_ax, \
                        ...
                        done = axioms2(greek2, pos1, pos2, rel1, rel2, sub1, obj1, sub2, obj2, osec_sent, tot_sent,
                                       used_ax, \
                                       candd, candd2, conditionals, all_sent, member_prop, not_id, prop_sent)
